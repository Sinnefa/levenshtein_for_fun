...
for i in range(100):
	a = ''.join(random.choices(["a","c","t","g"], k = random.randint(2,13)))
	b = ''.join(random.choices(["a","c","t","g"], k = random.randint(2,13)))
	# Levenshtein package
